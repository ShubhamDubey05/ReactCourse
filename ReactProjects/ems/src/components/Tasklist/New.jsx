  ...
  return (
    <div className="h-full w-[300px] flex-shrink-0 rounded-xl p-5 bg-green-400">
      ...
      <div className='mt-4 flex justify-between'>
        <button className='bg-blue-500 text-white px-4 py-2 rounded-md'>Let's Start</button>
        <button className='bg-red-500 text-white px-4 py-2 rounded-md'>Status</button>
      </div>
    </div>
  )
}
