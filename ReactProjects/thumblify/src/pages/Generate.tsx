...
import { colorSchemes, dummyThumbnails } from '../assests/assets'
import type { ThumbnailStyle, AspectRatio, IThumbnail } from '../assests/assets'
import { SoftBackdrop } from '../components/SoftBackdrop'
import { AspectRatioSelector } from '../components/AspectRatioSelector'
import { StyleSelector } from '../components/StyleSelector'
import { ColorSchemeSelector } from '../components/ColorSchemeSelector'
import { PreviewPanel } from '../components/PreviewPannel'
              ...
              <div className='p-6 rounded-2xl bg-white/8 border border-white/12 shadow-xl space-y-6'>
                ...
                <div className='space-y-5'>
                  ...
                  <input
                    ...
                    maxLength={100}
                    placeholder='e.g., How to design a website in 2 mins'
                ...
                {!id && (
                  <button
                    ...
                    className='text-[15px] w-full py-3.5 rounded-xl font-medium bg-gradient-to-b from-pink-500 to-pink-600 hover:from-pink-700 disabled:cursor-not-allowed disabled:opacity-50 transition'
                  >
