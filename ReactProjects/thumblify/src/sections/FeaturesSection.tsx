...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="Why use our genrator?" text3="Create a stunning thumbnails that get clicks , without the hassle." />
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                    Our AI understands what make a video go viral and and designs thumbnails accordingly.
                </motion.p>
